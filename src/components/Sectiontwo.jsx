        ...
        <div className="relative isolate overflow-hidden bg-gray-200 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
          ...
          <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
            <h2 className="text-3xl font-bold tracking-tight text-black sm:text-4xl">
              Streamlining the knowlegde from Data
              <br />
          ...
          <div className="relative mt-16 h-80 lg:mt-8">
            <img
              className="absolute h-[20rem] left-0 top-0 w-[25rem] max-w-none rounded-md bg-white/5 ring-1 ring-white/10 sm:h-[35rem] sm:w-[35rem]"
              src="https://firebasestorage.googleapis.com/v0/b/onecrewtechs.appspot.com/o/absurd.design%20-%20Chapter%201%20-%2034.png?alt=media&token=5f9b6374-7e3c-46fa-ba37-d298b5e5b7a8"
              alt="App screenshot"
              width={1824}
              height={1080}
            />
